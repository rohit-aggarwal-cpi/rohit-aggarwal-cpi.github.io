...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js"), __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js"), __webpack_require__(/*! core/services/api.service */ "./src/app/core/services/api.service.ts")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, core_1, http_1, api_service_1) {
    ...
    var LeaveService = (function (_super) {
        ...
        LeaveService.prototype.approve = function (leave_id) {
            return this.put(this._base_url + '/approve/' + leave_id, {})
                .then(function (response) { return response; });
        };
        LeaveService.prototype.reject = function (leave_id) {
            return this.put(this._base_url + '/reject/' + leave_id, {})
                .then(function (response) { return response; });
        };
        LeaveService.prototype.cancel = function (leave_id) {
            return this.delete(this._base_url + '/cancel/' + leave_id)
                .then(function (response) { return response; });
        };
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js"), __webpack_require__(/*! modules/leave/leave.service */ "./src/app/modules/leave/leave.service.ts"), __webpack_require__(/*! core/services/authorization.service */ "./src/app/core/services/authorization.service.ts"), __webpack_require__(/*! config/constants/leave */ "./src/app/config/constants/leave.ts")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, core_1, leave_service_1, authorization_service_1, leave_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var ListLeaveComponent = (function () {
        function ListLeaveComponent(leaveService, authorization) {
            this.leaveService = leaveService;
        ...
        ListLeaveComponent = __decorate([
            core_1.Component({
                ...
                encapsulation: core_1.ViewEncapsulation.None,
                providers: [leave_service_1.LeaveService, authorization_service_1.Authorization]
            }),
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js"), __webpack_require__(/*! modules/leave/leave.service */ "./src/app/modules/leave/leave.service.ts"), __webpack_require__(/*! config/constants/leave */ "./src/app/config/constants/leave.ts")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, core_1, leave_service_1, leave_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var ReviewLeaveComponent = (function () {
        function ReviewLeaveComponent(leaveService) {
            this.leaveService = leaveService;
            this.leaves = [];
            this.reviewed = [];
            this.approving = [];
        ...
        ReviewLeaveComponent.prototype.loadLeaves = function () {
            ...
            this.leaveService.getLeaves(query).then(function (leaves) {
                self.leaves = leaves;
            });
        };
...
//# sourceMappingURL=11.e0972d7f71a7158c4313.js.map