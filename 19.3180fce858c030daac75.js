...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js"), __webpack_require__(/*! lodash */ "./node_modules/lodash/lodash.js"), __webpack_require__(/*! config/constants/user */ "./src/app/config/constants/user.ts"), __webpack_require__(/*! modules/user/profile/profile.service */ "./src/app/modules/user/profile/profile.service.ts"), __webpack_require__(/*! shared/helpers/utility */ "./src/app/shared/helpers/utility.ts"), __webpack_require__(/*! shared/components/success-modal/success-modal.component */ "./src/app/shared/components/success-modal/success-modal.component.ts"), __webpack_require__(/*! shared/components/error-modal/error-modal.component */ "./src/app/shared/components/error-modal/error-modal.component.ts"), __webpack_require__(/*! ../../../shared/components/address/address.component */ "./src/app/shared/components/address/address.component.ts"), __webpack_require__(/*! ../../../core/providers/exatask.service */ "./src/app/core/providers/exatask.service.ts")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, core_1, lodash_1, user_1, profile_service_1, utility_1, success_modal_component_1, error_modal_component_1, address_component_1, exatask_service_1) {
    "use strict";
    ...
    var ProfileComponent = (function () {
        function ProfileComponent(profileService, exatask) {
            this.profileService = profileService;
            this.exatask = exatask;
            this.exatask.setTitle('Profile');
        ...
        ProfileComponent.prototype.ngOnInit = function () {
            ...
            this.profileService.getProfile('profile1,profile2,profile3')
                ...
                if (!_this.profile.permanent_address) {
                    _this.profile.permanent_address = new address_component_1.Address();
                }
                if (!_this.profile.correspondence_address) {
                    _this.profile.correspondence_address = new address_component_1.Address();
                }
                ...
                _this.exatask.setTitle('Profile : ' + profile_service_1.Name.getFullName(_this.profile.name));
            });
        };
        ...
        ProfileComponent.prototype.addSocialSecurity = function () {
            ...
            this.maxSocialSecurityTypes = this.profile.social_security.length === Object.keys(user_1.SOCIAL_SECURITY_TYPE).length;
        };
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js"), __webpack_require__(/*! ../profile/profile.service */ "./src/app/modules/user/profile/profile.service.ts"), __webpack_require__(/*! shared/components/success-modal/success-modal.component */ "./src/app/shared/components/success-modal/success-modal.component.ts"), __webpack_require__(/*! shared/components/error-modal/error-modal.component */ "./src/app/shared/components/error-modal/error-modal.component.ts"), __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js"), __webpack_require__(/*! core/providers/access.service */ "./src/app/core/providers/access.service.ts"), __webpack_require__(/*! config/constants/user */ "./src/app/config/constants/user.ts"), __webpack_require__(/*! ../../../core/providers/exatask.service */ "./src/app/core/providers/exatask.service.ts")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, core_1, profile_service_1, success_modal_component_1, error_modal_component_1, router_1, access_service_1, user_1, exatask_service_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var SecurityComponent = (function () {
        function SecurityComponent(profileService, route, access, exatask) {
            this.profileService = profileService;
            this.route = route;
            this.access = access;
            this.exatask = exatask;
            ...
            this.exatask.setTitle('Security');
        ...
        SecurityComponent.prototype.__loadMfa = function () {
            var _this = this;
            this.profileService.getProfile('auth').then(function (data) {
                if (data.mfa) {
...
//# sourceMappingURL=19.3180fce858c030daac75.js.map