...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js"), __webpack_require__(/*! modules/leave/leave.service */ "./src/app/modules/leave/leave.service.ts"), __webpack_require__(/*! config/constants/leave */ "./src/app/config/constants/leave.ts"), __webpack_require__(/*! core/providers/access.service */ "./src/app/core/providers/access.service.ts"), __webpack_require__(/*! ../../../core/providers/exatask.service */ "./src/app/core/providers/exatask.service.ts"), __webpack_require__(/*! ../../user/profile/profile.service */ "./src/app/modules/user/profile/profile.service.ts")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, core_1, leave_service_1, leave_1, access_service_1, exatask_service_1, profile_service_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var ListLeaveComponent = (function () {
        function ListLeaveComponent(leaveService, profileService, access, exatask) {
            this.leaveService = leaveService;
            this.profileService = profileService;
            this.access = access;
            this.exatask = exatask;
                    ...
                    switch (_d.label) {
                        ...
                        case 3:
                            ...
                            this.profileService.getProfile('policies').then(function (profile) {
                                if (profile.policies && profile.policies.leave && profile.policies.leave.length > 0) {
        ...
        ListLeaveComponent = __decorate([
            core_1.Component({
                ...
                encapsulation: core_1.ViewEncapsulation.None,
                providers: [leave_service_1.LeaveService, profile_service_1.ProfileService]
            }),
...
//# sourceMappingURL=12.4856eb366c3f0108a8c2.js.map