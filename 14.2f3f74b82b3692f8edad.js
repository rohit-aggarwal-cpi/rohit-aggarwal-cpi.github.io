...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js"), __webpack_require__(/*! modules/work-from-home/work-from-home.service */ "./src/app/modules/work-from-home/work-from-home.service.ts"), __webpack_require__(/*! config/constants/wfh */ "./src/app/config/constants/wfh.ts"), __webpack_require__(/*! core/services/authorization.service */ "./src/app/core/services/authorization.service.ts")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, core_1, work_from_home_service_1, wfh_1, authorization_service_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var ListWfhComponent = (function () {
        function ListWfhComponent(wfhService, authorization) {
            this.wfhService = wfhService;
                    ...
                    switch (_c.label) {
                        case 0:
                            ...
                            return [4, this.authorization.hasAccess({
                                    entity: 'work_from_home:work_from_home',
                                    action: 'create:post'
                                })];
                        case 1:
        ...
        ListWfhComponent = __decorate([
            core_1.Component({
                ...
                encapsulation: core_1.ViewEncapsulation.None,
                providers: [work_from_home_service_1.WfhService, authorization_service_1.Authorization]
            }),
            __metadata("design:paramtypes", [work_from_home_service_1.WfhService,
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js"), __webpack_require__(/*! modules/work-from-home/work-from-home.service */ "./src/app/modules/work-from-home/work-from-home.service.ts"), __webpack_require__(/*! config/constants/wfh */ "./src/app/config/constants/wfh.ts")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, core_1, work_from_home_service_1, wfh_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var ReviewWfhComponent = (function () {
        function ReviewWfhComponent(wfhService) {
            this.wfhService = wfhService;
            this.wfhs = [];
            this.reviewed = [];
            this.approving = [];
        ...
        ReviewWfhComponent.prototype.loadWfhs = function () {
            ...
            this.wfhService.getWfhs(query).then(function (wfhs) {
                self.wfhs = wfhs;
            });
        };
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js"), __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js"), __webpack_require__(/*! core/services/api.service */ "./src/app/core/services/api.service.ts")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, core_1, http_1, api_service_1) {
    ...
    var WfhService = (function (_super) {
        ...
        WfhService.prototype.approve = function (wfh_id) {
            return this.put(this._base_url + '/approve/' + wfh_id, {})
                .then(function (response) { return response; });
        };
        WfhService.prototype.reject = function (wfh_id) {
            return this.put(this._base_url + '/reject/' + wfh_id, {})
                .then(function (response) { return response; });
        };
        WfhService.prototype.cancel = function (wfh_id) {
            return this.delete(this._base_url + '/cancel/' + wfh_id)
                .then(function (response) { return response; });
        };
...
//# sourceMappingURL=14.2f3f74b82b3692f8edad.js.map