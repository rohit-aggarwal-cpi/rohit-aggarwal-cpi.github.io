(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["modules-application-module"],{
...
module.exports = "<div class=\"animated fadeIn\">\n  <div class=\"row\">\n\n    <app-department-summary [ngClass]=\"'col-3'\"></app-department-summary>\n    <app-leave-summary [ngClass]=\"'col-3'\"></app-leave-summary>\n\n  </div>\n</div>\n"
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js"), __webpack_require__(/*! core/services/graphql.service */ "./src/app/core/services/graphql.service.ts"), __webpack_require__(/*! graphql-tag */ "./node_modules/graphql-tag/src/index.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, core_1, graphql_service_1, graphql_tag_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var DEPARTMENT_SUMMARY = graphql_tag_1.default(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  query {\n    department_summary {\n      count\n      employee_count\n      departments {\n        name\n        employee_count\n      }\n    }\n}\n"], ["\n  query {\n    department_summary {\n      count\n      employee_count\n      departments {\n        name\n        employee_count\n      }\n    }\n}\n"])));
    var DepartmentSummaryComponent = (function () {
        function DepartmentSummaryComponent(graphqlService) {
            this.graphqlService = graphqlService;
            this.result = new DepartmentSummary();
        }
        DepartmentSummaryComponent.prototype.ngOnInit = function () {
            var self = this;
            this.graphqlService.query(DEPARTMENT_SUMMARY.loc.source.body).then(function (response) {
                self.result = response.data.department_summary;
            });
        };
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js"), __webpack_require__(/*! core/services/graphql.service */ "./src/app/core/services/graphql.service.ts"), __webpack_require__(/*! graphql-tag */ "./node_modules/graphql-tag/src/index.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, core_1, graphql_service_1, graphql_tag_1) {
    ...
    var LEAVE_SUMMARY = graphql_tag_1.default(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  query {\n    leave_summary {\n      leave_type\n      leaves\n    }\n  }\n"], ["\n  query {\n    leave_summary {\n      leave_type\n      leaves\n    }\n  }\n"])));
    var LeaveSummaryComponent = (function () {
        function LeaveSummaryComponent(graphqlService) {
            this.graphqlService = graphqlService;
            this.result = new LeaveSummary();
        }
        LeaveSummaryComponent.prototype.ngOnInit = function () {
            var self = this;
            this.graphqlService.query(LEAVE_SUMMARY.loc.source.body).then(function (response) {
                self.result = response.data.leave_summary;
            });
        };
...
//# sourceMappingURL=modules-application-module.js.map