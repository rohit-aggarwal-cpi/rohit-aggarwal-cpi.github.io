...
/***/ "./src/app/modules/employee/employee-leave-policy/employee-leave-policy.service.ts":
/*!*****************************************************************************************!*\
  !*** ./src/app/modules/employee/employee-leave-policy/employee-leave-policy.service.ts ***!
  \*****************************************************************************************/
/*! no static exports found */
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js"), __webpack_require__(/*! core/services/api.service */ "./src/app/core/services/api.service.ts")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, core_1, api_service_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var EmployeeLeavePolicyService = (function (_super) {
        __extends(EmployeeLeavePolicyService, _super);
        function EmployeeLeavePolicyService() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this._base_url = '/employees/leavepolicies';
            return _this;
        }
        EmployeeLeavePolicyService.prototype.getEmployeeLeavePolicy = function (id) {
            return this.get(this._base_url + '/' + id)
                .then(function (response) { return response; });
        };
        EmployeeLeavePolicyService = __decorate([
            core_1.Injectable()
        ], EmployeeLeavePolicyService);
        return EmployeeLeavePolicyService;
    }(api_service_1.Api));
    exports.EmployeeLeavePolicyService = EmployeeLeavePolicyService;
}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
...
//# sourceMappingURL=common.cce5fe39c2fbb81978b6.js.map