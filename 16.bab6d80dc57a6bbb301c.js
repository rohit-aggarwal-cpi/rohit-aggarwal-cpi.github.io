...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js"), __webpack_require__(/*! modules/access-control/access-control.service */ "./src/app/modules/access-control/access-control.service.ts"), __webpack_require__(/*! core/providers/access.service */ "./src/app/core/providers/access.service.ts")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, core_1, access_control_service_1, access_service_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var ListAccessControlComponent = (function () {
        function ListAccessControlComponent(accessControlService, access) {
        ...
        ListAccessControlComponent = __decorate([
            ...
            __metadata("design:paramtypes", [access_control_service_1.AccessControlService, access_service_1.Access])
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js"), __webpack_require__(/*! ngx-treeview */ "./node_modules/ngx-treeview/src/index.js"), __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js"), __webpack_require__(/*! lodash */ "./node_modules/lodash/lodash.js"), __webpack_require__(/*! lodash */ "./node_modules/lodash/lodash.js"), __webpack_require__(/*! shared/components/success-modal/success-modal.component */ "./src/app/shared/components/success-modal/success-modal.component.ts"), __webpack_require__(/*! shared/components/error-modal/error-modal.component */ "./src/app/shared/components/error-modal/error-modal.component.ts"), __webpack_require__(/*! modules/access-control/access-control.service */ "./src/app/modules/access-control/access-control.service.ts")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, core_1, ngx_treeview_1, router_1, lodash_1, lodash_2, success_modal_component_1, error_modal_component_1, access_control_service_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var ManageAccessControlComponent = (function () {
        function ManageAccessControlComponent(route, accessControlService) {
            this.route = route;
            this.accessControlService = accessControlService;
        ...
        ManageAccessControlComponent.prototype.__getTreeviewItem = function (value, text, collapsed, disabled, checked) {
            collapsed = !!collapsed;
            disabled = !!disabled;
            checked = !!checked;
        ...
        ManageAccessControlComponent.prototype.__loadEntities = function () {
            var _this = this;
            var create = lodash_2.isEmpty(this.access_control._id);
                ...
                for (var _i = 0, response_1 = response; _i < response_1.length; _i++) {
                    ...
                    for (var _a = 0, _b = module_1.entities; _a < _b.length; _a++) {
                        ...
                        for (var _c = 0, _d = entity.actions; _c < _d.length; _c++) {
                            ...
                            tree_actions.push(_this.__getTreeviewItem(action.action_id, action.title, true, !_this.access_control.update.actions, treeitem_checked));
                        }
                        var entity_tree_item = _this.__getTreeviewItem(entity._id, entity.entity, true, !_this.access_control.update.actions, create);
                        entity_tree_item.children = tree_actions;
                        tree_entities.push(entity_tree_item);
                    }
                    var module_tree_item = _this.__getTreeviewItem(module_1.module_code, module_1.module, true, !_this.access_control.update.actions, create);
        ...
        ManageAccessControlComponent.prototype.__loadAttributes = function () {
            ...
            this.accessControlService.getAttributes()
                ...
                for (var _i = 0, response_2 = response; _i < response_2.length; _i++) {
                    ...
                    var newAttribute = _this.__getTreeviewItem(row.model, row.name, true, !_this.access_control.update.attributes, create);
                    ...
                    if (row.find) {
                        findAttribute = _this.__getTreeviewItem(row.model + '--find', 'Retrieve', true, !_this.access_control.update.attributes, create);
                    ...
                    if (row.update) {
                        updateAttribute = _this.__getTreeviewItem(row.model + '--update', 'Update', true, !_this.access_control.update.attributes, create);
        ...
        ManageAccessControlComponent.prototype.selectedEntity = function (event) {
            ...
            event.map(function (entity) {
                ...
                self.access_control.actions = lodash_2.uniq(self.access_control.actions);
            });
        };
        ManageAccessControlComponent.prototype.selectedAttribute = function (event) {
            ...
            event.map(function (attribute) {
                ...
                var index = self.__getIndex(self.access_control.attributes, model, 'model');
                var attribute_index = self.__getIndex(self.allowedAttributes, model, 'model');
                if (index === -1) {
...
//# sourceMappingURL=16.bab6d80dc57a6bbb301c.js.map